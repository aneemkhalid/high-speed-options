 ...
 * Template Name: Template - Commercial Page Old
 * @package HSO
 */
...
get_header();
	...
	while ( have_posts() ) :
		...
		<section id="commercial_page_template" class="vertical_page_template">
			<div class="container">
					...
					<div class="commercial_page_left_content">
						...
						<div class="author-detail_wrapper">
							...
							<div class="social_share">
								<a id="facebook" href="https://www.facebook.com/sharer?u=<?php the_permalink() ?>&amp;t=<?php the_title(); ?>" target="_blank" rel="noopener noreferrer"><img src="<?php echo get_template_directory_uri() ?>/images/facebook_social_share.svg"></a>
								<a id="twitter" href="https://twitter.com/intent/tweet?url=<?php the_permalink() ?>&amp;text=<?php the_title(); ?>" target="_blank" rel="noopener noreferrer"><img src="<?php echo get_template_directory_uri() ?>/images/twitter_social_share.svg"></a>
								<a id="linkedin" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php the_permalink() ?>" target="_blank" rel="noopener noreferrer"><img src="<?php echo get_template_directory_uri() ?>/images/linkedin_social_share.svg"></a>
							</div>
						</div>
						<?php 
							if(!wp_is_mobile()){
								...
								if(get_field('general_descriptions')){
									echo '<h2>What is '.get_the_title().'?</h2>';
									echo '<p>'.get_field('general_descriptions').'</p>';
								}
							}
						?>
						<?php the_content(); ?>
