 ...
 * Template Name: Template - Commercial Page
...
get_header();
	...
	while ( have_posts() ) :
		...
		<section id="commercial_page_template" class="toc-sidebar-commercial-page vertical_page_template">
			<div class="container">
						...
						<?php 
							if(!wp_is_mobile()){
								if(!empty(get_the_post_thumbnail_url())){
									...
									//echo '<img src="'.get_the_post_thumbnail_url().'" width="716" height="477">';
