...
// NEW CODE
$CompareProvidersHs = get_field( "compare_providers_horizontal_scroll" );
$ProviderType = $CompareProvidersHs['provider_type'];
...
//echo "<pre>"; print_r( $ProviderType ); echo "</pre>";

if ( strtolower( $ProviderType ) == "internet" ){
    include("compare-hs-internet.php");
}else if( strtolower( $ProviderType ) == "tv" ){
   include("compare-hs-tv.php");
}else{
// NEW CODE
    ...
    foreach( $fixed_columns as $column ) {
        ...
        if( in_array( $field_name, $link_values ) ) {
            ...
            if( $field_name === 'logo' ) {
                ...
                $link_target = '<img src="'.$link_target.'" class="provider-logo">';
...
/*          if ($cta_text === 'View Plans' ) {
          ...
          $providerScrollProductClick = dataLayerProdClick($provider->ID , $variantProvider, $providerScrollCounter,  $providerScrollSlug, $compare_providers['heading']);
            

            if ($button_type == 'popup'){
                $dataCheckAvailOnClick = 'onclick="'.dataLayerCheckAvailabilityClick($provider->ID, $providerScrollSlug).'"';
            }
            
            $field = '<a href="'.$link.'" class="'.$class.'" onclick="'.$providerScrollProductClick.'">'.$link_target.'</a>';
            ...
            if( $field_name === 'button' ) $field = '<a href="'.$cta_link.'" class="cta-btn '.$zip_popup_class.' '.$class.'" '.$data_att.' '.$target.' '.$dataCheckAvailOnClick.'>'.$cta_text.'</a>';
        }
...
$source = $compare_providers['source'];
...
<div id="scrolltable">
    ...
    <div class="compare-providers-blocks-list mobile">
      ...
      /*    if ($cta_text === 'View Plans' ) {
          ...
          $providerMobileScrollSlug = get_post_field( 'post_name', get_post() );
          $providerMobileScrollCounter++;
          $providerScrollMobileProductClick = dataLayerProdClick($provider->ID , $variantProvider, $providerMobileScrollCounter,  $providerMobileScrollSlug, $compare_providers['heading']);
            ...
            <div class="compare-providers-block">
                <div class="provider-logo-wrapper provider-data-container">
                    ...
                    <div class="provider-logo-container">
                        <a href="<?php echo $link; ?>" class="provider-logo-link" onclick="<?php echo $providerScrollMobileProductClick ?>">
                ...
                <div class="provider-title-container provider-data-container">
                    ...
                    <div class="data-value-container">
                        <a href="<?php echo $link; ?>" class="provider-title-link" onclick="<?php echo $providerScrollMobileProductClick ?>"><?php echo $provider->post_title; ?></a>
                    </div>
                </div>
                        ...
                        if (is_array($data_type_subfields[$field_name])){
                            $value = implode(', ', $data_type_subfields[$field_name]);
                             ...
                             if ($field_name == 'starting_price'){
                                ...
                                $value = '$'.$data_type_subfields[$field_name].'/mo' . $Fld_Ast;
                            } elseif ($field_name == 'minimum_channel_count') {
