...
//echo "<pre>"; print_r( $FilterResult . "|" . $ProviderFilter ); echo "</pre>";
...
// Add Last Column
$Tbl_Columns[] = '';
//echo "<pre>"; print_r( $Tbl_Columns ); echo "</pre>";
//echo "<pre>"; print_r( $Tbl_ColumnsVal ); echo "</pre>";

if ( $ProviderType == "internet") {
    include( "compare-provider-tbl-internet.php" );
}else if ( $ProviderType == "tv"){
   include( "compare-provider-tbl-tv.php" );
// NEW CODE

}else{
// OLD CODE */
$compare_providers = get_field('compare_providers');
$heading = $compare_providers['heading'];
$body_text = $compare_providers['text'];
...
$cta_button = $compare_providers['cta_button'];
            ...
            <thead>
                <th>Provider</th>';
                    if($table_columns){
                     ...
                     if($cta_button) $desktop_table .= '<th></th>';
            $desktop_table .= '
            </thead>';
            ...
            if($table_columns){
                foreach ($providers as $key => $providerID) {
                    ...
                    <tr>
                        ...
                        if($cta_button) $desktop_table .= '<td class="text-right"><a href="'.$cta_link.'" class="cta_btn" '.$target.'>'.$cta_text.'</a></td>';
                        if($cta_button) $mobile_table .= '<tr><td class="text-center" colspan="2"><a href="'.$cta_link.'" class="cta_btn" '.$target.'>'.$cta_text.'</a></td></tr>';
                    $desktop_table .= '
                    </tr>';
                }
            }
